...
function MapsPage(props) {
    ...
    return (
        <div>
            ...
            <LoadScript googleMapsApiKey={"AIzaSyD7gA9N5aUDcKPmPeNoFwVZOT5HTMAR8Co"}>
                <GoogleMap
                ...
                >
                    {
                        parkingSpots.map((spot,index) => {
                            return(
                                ...
                                <div key={index} onClick={()=> setSelectedParkingSpot(spot[index].name)}>
                                <Marker
                ...
                <div className={style.section}>
                    {
                        selectedParkingSpot ? ({selectedParkingSpot}) : ( <p>
                            Selecteaza un loc de parcare
                        </p>)
                    }
                </div>
            </div>
