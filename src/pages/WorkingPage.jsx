                        ...
                        <div className={style.col1}>
                            {
                                parcareCamin1.map((spot,index) => {
                                    return(
                                        <div className={ style.spot}  style={{backgroundColor : getSpotClass(parcareCamin1,index)}} key={index} onClick={()=> handlecurrentSpotSelection1(index)}>
                        ...
                        <div className={style.col2}>
                            {
                                parcareCamin2.map((spot,index) => {
                                    return(
                                        <div className={style.spot} style={{backgroundColor : getSpotClass(parcareCamin2,index)}} key={index} onClick={()=> handlecurrentSpotSelection2(index)}>
                                            <div className={style.slotInterior}>
                            ...
                            error && (
                                ...
                                <p className={style.errorText}>
                                    Locul este Ocupat !
                                        ...
                                        <button onClick={()=>setError(false)} className={style.errorBtn}>
                                            Ok
                                        </button>
                                    </div>
                                </div>
                        ...
                        currentSpot && (
                            <>
                                <div className={style.step}>
                                    ...
                                    <input type="text" className={style.input} placeholder={"SB 93 MON"} onChange={(event)=>setNumarInmatriculare(event.target.value)}/>
                                </div>
